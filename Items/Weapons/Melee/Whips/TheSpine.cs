...
namespace ElementsAwoken.Items.Weapons.Melee.Whips
{
    public class TheSpine : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("TheSpineP");
            item.shootSpeed = 15f;

        }
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Spine");
        }
        public override void AddRecipes()
        {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Bloodchain", 1);
            recipe.AddIngredient(null, "CrashingWave", 1);
            recipe.AddIngredient(null, "TheVine", 1);
            recipe.AddIngredient(null, "Flarelash", 1);
