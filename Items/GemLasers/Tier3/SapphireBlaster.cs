...
{
    public class SapphireBlaster : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Sapphire Blaster");
            Tooltip.SetDefault("Charges musket balls with cerulean light");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "SapphireRifle", 1);
