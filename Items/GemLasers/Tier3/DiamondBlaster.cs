...
{
    public class DiamondBlaster : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Diamond Blaster");
            Tooltip.SetDefault("Charges musket balls with white light");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "DiamondRifle", 1);
