...
{
    public class VoidLeviathanTail : ModNPC
    {
        ...
        {
            Texture2D texture = mod.GetTexture("NPCs/Bosses/VoidLeviathan/Glow/VoidLeviathanTail_Glow");
        ...
        public override bool PreAI()
        {
            ...
            if (npc.ai[1] < (double)Main.npc.Length)
            {
                ...
                // using center, we calculate the direction towards the 'parent NPC' of this NPC.
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life <= 0)
            {
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/VoidLeviathanTail"), 1.1f);
