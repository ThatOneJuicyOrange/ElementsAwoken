    ...
    public class EtherealHunter : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spritebatch, Color drawColor)
        {
            ...
            for (int k = 0; k < npc.oldPos.Length; k++)
            {
                ...
                spritebatch.Draw(mod.GetTexture("NPCs/VoidEventEnemies/Phase2/EtherealHunter_Eyes"), drawPos, null, Color.White, npc.rotation, drawOrigin, npc.scale, spriteEffects, 0f);
            }
            return false;
        }
