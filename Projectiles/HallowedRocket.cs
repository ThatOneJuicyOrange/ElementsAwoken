...
namespace ElementsAwoken.Projectiles
{
    public class HallowedRocket : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int dustType = Main.rand.Next(2) == 0 ? 58 : 59;
                int num372 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, dustType, 0f, 0f, 100, default(Color), 2.5f);
                Main.dust[num372].noGravity = true;
                Main.dust[num372].velocity *= 5f;
                num372 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, dustType, 0f, 0f, 100, default(Color), 1.5f);
