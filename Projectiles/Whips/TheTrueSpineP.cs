...
namespace ElementsAwoken.Projectiles.Whips
{
    public class TheTrueSpineP : ModProjectile
    {
        ...
        {       
            ...
            {
                Projectile.NewProjectile(projectile.position.X + projectile.velocity.X, projectile.position.Y + projectile.velocity.Y, projectile.velocity.X * 0.075f, projectile.velocity.Y * 0.075f, mod.ProjectileType("TrueSpineBall"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
            }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("HealProjBlood"), 0, 0f, Main.myPlayer, Main.myPlayer, Main.rand.Next(2, 6)); // ai 1 is how much it heals
            }
        }
    }
}