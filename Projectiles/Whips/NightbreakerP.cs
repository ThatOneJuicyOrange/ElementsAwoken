        ...
        {       
            ...
            if (projectile.ai[0] == timeAlive / 2)
            {
                ...
                for (int i = 0; i < numProj; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.position.X + projectile.velocity.X, projectile.position.Y + projectile.velocity.Y, perturbedSpeed.X, perturbedSpeed.Y, mod.ProjectileType("NightbreakerBall"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                }
            }
