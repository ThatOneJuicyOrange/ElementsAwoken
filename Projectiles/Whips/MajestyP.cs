    ...
    public class MajestyP : ModProjectile
    {
        ...
        {       
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.position + projectile.velocity, Main.rand.NextVector2Square(-3,3), ProjectileType<RadiantStarHoming>(), projectile.damage, projectile.knockBack, projectile.owner);
                }
            }
