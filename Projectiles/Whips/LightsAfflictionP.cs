...
namespace ElementsAwoken.Projectiles.Whips
{
    public class LightsAfflictionP : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("TheSpine");
        }
        ...
        {       
            ...
            if (projectile.alpha == 0)
            {
                ...
                {
                    Dust dust = Main.dust[Dust.NewDust(projectile.position + projectile.velocity * 2f, projectile.width, projectile.height, DustID.PinkFlame, 0f, 0f, 100, default(Color), 2f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
                ...
                while ((float)num53 < num52)
                {
                    if (Main.rand.Next(4) == 0)
                    {
                        ...
                        Dust dust2 = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, DustID.PinkFlame, 0f, 0f, 100, default(Color), 1f)];
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            int num232 = 20; // how many chains there are
            if (flag24)
            {
                num232 = 10;
            }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0, 0, mod.ProjectileType("LightsAfflictionExplosion"), projectile.damage, 0, projectile.owner);
        }
    }
}