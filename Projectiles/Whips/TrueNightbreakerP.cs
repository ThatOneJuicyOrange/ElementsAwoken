...
namespace ElementsAwoken.Projectiles.Whips
{
    public class TrueNightbreakerP : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("True Nightbreaker");
        }
        ...
        {       
            ...
            {
                Projectile.NewProjectile(projectile.position.X + projectile.velocity.X, projectile.position.Y + projectile.velocity.Y, projectile.velocity.X * 0.05f, projectile.velocity.Y * 0.05f, mod.ProjectileType("NightbreakerBlade"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
            }
