...
namespace ElementsAwoken.Projectiles.Whips
{
    public class TheSpineP : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("HealProjBlood"), 0, 0f, Main.myPlayer, Main.myPlayer, Main.rand.Next(1, 4)); // ai 1 is how much it heals
            }
        }
    }
}