...
namespace ElementsAwoken.Projectiles.Whips
{
    public class OrionsBeltP : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Orions Belt");
        }
        ...
        {       
            ...
            if (!createdGalaxy)
            {
                ...
                for (int l = 0; l < swirlCount; l++)
                {
                    ...
                    int orbital = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("OrionsBeltGalaxy"), projectile.damage, projectile.knockBack, projectile.owner, l * distance, projectile.whoAmI);
                }
                createdGalaxy = true;
            }
