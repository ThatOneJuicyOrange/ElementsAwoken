...
namespace ElementsAwoken.Projectiles
{
    public class SWRLRocket : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num372 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 181, 0f, 0f, 100, default(Color), 2.5f);
                Main.dust[num372].noGravity = true;
                Main.dust[num372].velocity *= 3f;
                num372 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 181, 0f, 0f, 100, default(Color), 1.5f);
