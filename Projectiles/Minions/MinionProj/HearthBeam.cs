...
namespace ElementsAwoken.Projectiles.Minions.MinionProj
{
    public class HearthBeam : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Hearth Beam");
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D tailTex = mod.GetTexture("Projectiles/Minions/MinionProj/HearthBeamTail");
            Texture2D beamTex = Main.projectileTexture[projectile.type];
            Texture2D headTex = mod.GetTexture("Projectiles/Minions/MinionProj/HearthBeamHead");
