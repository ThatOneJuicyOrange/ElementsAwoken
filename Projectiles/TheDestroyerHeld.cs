            ...
            if (Main.myPlayer == projectile.owner)
            {
                if ((player.channel && player.CheckMana(player.inventory[player.selectedItem].mana, true, false)) && !player.noItems && !player.CCed)
                {
                    if (projectile.ai[0] >= chargeLevel3)
                    {
                        ...
                        Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector16.X, vector16.Y, mod.ProjectileType("DestroyerLaserFull"), damage, projectile.knockBack, projectile.owner, 0f, 0f);
                ...
                else
                {
                    if (projectile.ai[0] < chargeLevel3)
                    {
                        ...
                        Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector16.X, vector16.Y, mod.ProjectileType("DestroyerLaserHalf"), damage, projectile.knockBack, projectile.owner, 0f, 0f);
