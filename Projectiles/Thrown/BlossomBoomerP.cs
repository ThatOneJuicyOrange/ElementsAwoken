...
namespace ElementsAwoken.Projectiles.Thrown
{
    public class BlossomBoomerP : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int explosion = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("Explosion"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
