    ...
    public class ElectricBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int num134 = 0; num134 < 10; num134++)
            {
                ...
                int num135 = Dust.NewDust(new Vector2(x, y), 1, 1, 229, 0f, 0f, 0, default(Color), 1.25f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int k = 0; k < 10; k++)
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 229, projectile.oldVelocity.X * 0.5f, projectile.oldVelocity.Y * 0.5f); //206 160 226
            }
        }
    }
}