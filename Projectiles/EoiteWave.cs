...
namespace ElementsAwoken.Projectiles
{
    public class EoiteWave : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("EoiteWave");
        }
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("Explosion"), (int)(projectile.damage * 0.75f), projectile.knockBack, projectile.owner, 0f, 0f);
