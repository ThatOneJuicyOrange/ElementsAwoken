...
namespace ElementsAwoken.Projectiles
{
    public class FusionOrb6 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.PinkFlame, 0f, 0f, 0, default(Color), 1.2f);
