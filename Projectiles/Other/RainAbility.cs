...
{
    public class RainAbility : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spritebatch, Color lightColor)
        {
            ...
            Color value35 = new Color(66, 135, 245, 127);
            Color color50 = new Color(59, 245, 242, 127);
            ...
            for (float num267 = (float)((int)bottom.Y); num267 > (float)((int)top.Y); num267 -= num265)
            {
                ...
                if (flag26)
                {
                    ...
                    color52 *= scale9;
                    Main.spriteBatch.Draw(texture2D30, vector51, new Rectangle?(rectangle15), color52 * (1 - ((float)projectile.alpha / 255f)), num263 + num269, origin7, (1f + num270) * 0.8f, effects2, 0f);
                }
                Main.spriteBatch.Draw(texture2D30, vector51, new Rectangle?(rectangle15), color51 * (1 - ((float)projectile.alpha / 255f)), num263 + num269, origin7, (1f + num270), effects2, 0f);
            }
            return false;
        }
        ...
        public override void AI()
        {
            ...
            if (!ElementsAwoken.rainA.Current || modPlayer.abilityTimer < 0 || !player.active) ProjectileUtils.FadeOut(projectile, 255 / 20);
            else if (projectile.alpha > 0) projectile.alpha -= 255 / 30;
            ...
            if (projectile.ai[0] < num - 30f)
            {
                for (int j = 0; j < 1; j++)
                {
                    ...
                    Dust dust = Main.dust[Dust.NewDust(position2, 0, 0, 15, 0f, 0f, 0, default(Color), 1f)];
