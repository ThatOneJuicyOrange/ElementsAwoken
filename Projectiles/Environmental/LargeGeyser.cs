...
{
    public class LargeGeyser : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Large Geyser");
        }
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] >= charge + 180f && multiplier == 1)
            {
                multiplier = -0.25f;
            }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D headTex = mod.GetTexture("Projectiles/Environmental/LargeGeyserHead");
