        ...
        public override void AI()
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                if (flag11)
                {
                    ...
                    if (shootTimer <= 0)
                    {
                        Projectile.NewProjectile(projectile.Center.X - 4f, projectile.Center.Y, num404, num405, mod.ProjectileType("ZenithBeam2"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 0f);
                        shootTimer = 8;
                    }
                    return;
                }
