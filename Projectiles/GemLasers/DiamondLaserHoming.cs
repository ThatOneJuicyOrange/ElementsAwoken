...
{
    public class DiamondLaserHoming : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Diamond Laser");
        }
        public override void AI()
        {
            for (int num121 = 0; num121 < 5; num121++)
            {
                Dust dust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 63)];
