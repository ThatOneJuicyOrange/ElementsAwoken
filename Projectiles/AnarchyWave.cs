...
namespace ElementsAwoken.Projectiles
{
    public class AnarchyWave : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Anarchy Wave");
        }
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("Anarchy"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
