    ...
    public class AbyssalTentacle : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.scale < 1f)
            {
                ...
                {
                    int num893 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, Main.rand.NextBool() ? 54 : DustID.PinkFlame, projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 1.1f);
