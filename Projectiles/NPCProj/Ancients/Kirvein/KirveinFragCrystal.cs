    ...
    public class KirveinFragCrystal : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, mod.ProjectileType("KirveinCrystalFragment"), (int)(projectile.damage * 0.75f), 0f, 0);
            }
        }
    }
}