        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                for (int k = 0; k < Main.projectile.Length; k++)
                {
                    ...
                    if (k != projectile.whoAmI && (other.type == projectile.type || other.type == mod.ProjectileType("KirveinShard") || other.type == mod.ProjectileType("IzarisShard") || other.type == mod.ProjectileType("XernonShard"))
