    ...
    public class XernonShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                ProjectileUtils.PushOtherEntities(projectile, new List<int>() { mod.ProjectileType("KirveinShard"), mod.ProjectileType("KrecheusShard"), mod.ProjectileType("IzarisShard") });
            }
