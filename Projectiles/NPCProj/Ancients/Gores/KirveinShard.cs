    ...
    public class KirveinShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                ProjectileUtils.PushOtherEntities(projectile, new List<int>() { mod.ProjectileType("KrecheusShard"), mod.ProjectileType("XernonShard"), mod.ProjectileType("IzarisShard") });
