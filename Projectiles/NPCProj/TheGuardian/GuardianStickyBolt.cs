...
namespace ElementsAwoken.Projectiles.NPCProj.TheGuardian
{
    public class GuardianStickyBolt : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("ExplosionHostile"), 100, projectile.knockBack, projectile.owner, 0f, 0f);
