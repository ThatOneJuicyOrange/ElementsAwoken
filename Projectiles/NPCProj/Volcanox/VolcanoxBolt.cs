    ...
    public class VolcanoxBolt : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num252 = 0; num252 < num251; num252++)
            {
                ...
                Projectile.NewProjectile(projectile.oldPosition.X + (float)(projectile.width / 2), projectile.oldPosition.Y + (float)(projectile.height / 2), value15.X, value15.Y, mod.ProjectileType("GuardianFire"), 70, 0f, projectile.owner, 0f, 0f);
