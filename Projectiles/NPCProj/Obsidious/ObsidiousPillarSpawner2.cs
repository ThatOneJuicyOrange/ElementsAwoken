...
{
    public class ObsidiousPillarSpawner2 : ModProjectile
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(tex, projectile.Center - Main.screenPosition, null, new Color(255, 185, 138) * alphaScale * 0.7f, 0, new Vector2(tex.Width / 2, 0), new Vector2(2f, alphaScale * 2f),SpriteEffects.FlipVertically, 0f);
