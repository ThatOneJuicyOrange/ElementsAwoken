...
namespace ElementsAwoken.Projectiles.NPCProj.CosmicObserver
{
    public class ObserverBeam : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D tailTex = mod.GetTexture("Projectiles/NPCProj/CosmicObserver/ObserverBeamTail");
            Texture2D beamTex = Main.projectileTexture[projectile.type];
            Texture2D headTex = mod.GetTexture("Projectiles/NPCProj/CosmicObserver/ObserverBeamHead");
