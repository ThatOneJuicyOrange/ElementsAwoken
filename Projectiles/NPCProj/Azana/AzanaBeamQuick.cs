...
namespace ElementsAwoken.Projectiles.NPCProj.Azana
{
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Projectiles/NPCProj/Azana/AzanaBeam"; } }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D tailTex = mod.GetTexture("Projectiles/NPCProj/Azana/AzanaBeamTail");
            Texture2D beamTex = Main.projectileTexture[projectile.type];
            Texture2D headTex = mod.GetTexture("Projectiles/NPCProj/Azana/AzanaBeamHead");
