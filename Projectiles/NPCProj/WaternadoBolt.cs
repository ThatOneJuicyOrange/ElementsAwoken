        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                if (projectile.ai[1] < 1f)
                {
                    ...
                    int num330 = Projectile.NewProjectile(projectile.Center.X - (float)(projectile.direction * 30), projectile.Center.Y - 4f, (float)(-(float)projectile.direction) * 0.01f, 0f, mod.ProjectileType("Waternado"), num329, 4f, projectile.owner, 16f, 15f);
                ...
                else
                {
                    ...
                    int num336 = Projectile.NewProjectile((float)(num332 * 16 + 8), (float)(num331 * 16 - 24), 0f, 0f, mod.ProjectileType("Waternado"), num335, 4f, Main.myPlayer, 16f, 24f);
