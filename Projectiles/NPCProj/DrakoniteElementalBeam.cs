...
namespace ElementsAwoken.Projectiles.NPCProj
{
    public class DrakoniteElementalBeam : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Drakonic Beam");
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D tailTex = mod.GetTexture("Projectiles/NPCProj/DrakoniteElementalBeamTail");
            Texture2D beamTex = Main.projectileTexture[projectile.type];
            Texture2D headTex = mod.GetTexture("Projectiles/NPCProj/DrakoniteElementalBeamHead");
