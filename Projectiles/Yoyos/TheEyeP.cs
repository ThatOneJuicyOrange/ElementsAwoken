        ...
        public override void AI()
        {
            ...
            if (flag14)
            {
                ...
                if (projectile.localAI[0] > 16f)
                {
                    ...
                    num438 *= num440;
                    num439 *= num440;
                    Projectile.NewProjectile(value10.X, value10.Y, num438, num439, mod.ProjectileType("VoidBlast"), (int)((double)projectile.damage * 0.5f), projectile.knockBack, projectile.owner, 0f, 0f);
