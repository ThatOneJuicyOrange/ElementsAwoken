...
namespace ElementsAwoken.Projectiles
{
    public class StarLunar : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.NextFloat(-5f,5f), Main.rand.NextFloat(-5f, 5f), mod.ProjectileType("StarLunarFragment"), (int)(projectile.damage * 0.8f), 2f, projectile.owner, projectile.ai[0], 0f);
            }
        }
    }
}