...
{
    public class InfiniteSkyBase : ModProjectile
    {
        ...
        public override void AI()
        {
            if (projectile.ai[0] == 0)
            {
                ...
                for (int l = 0; l < swirlCount; l++)
                {
                    //cos = y, sin = x
                    int distance = 59;
                    orbital = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("InfiniteSkySwirl"), 300, projectile.knockBack, projectile.owner, l * distance, projectile.whoAmI);
