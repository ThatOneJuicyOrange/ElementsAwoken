    ...
    public class PikeOfEternalDespairP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.player[projectile.owner].itemAnimation == Main.player[projectile.owner].itemAnimationMax / 3)
            {
                ...
                Projectile.NewProjectile(projPos.X, projPos.Y, projectile.velocity.X * 2f, projectile.velocity.Y * 2f, mod.ProjectileType("DespairBody"), projectile.damage, projectile.knockBack, projectile.owner);
            }
