    ...
    public class KindleCrusherP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (deathTimer > 50)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-2, 2), Main.rand.Next(-2, 2), mod.ProjectileType("KindleFireball"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                }
            }
            for (int k = 0; k < 200; k++)
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModContent.GetTexture("ElementsAwoken/Projectiles/Flails/KindleCrusherChain");
        ...
        {
            ProjectileGlobal.Explosion(projectile, new int[] { 6 }, projectile.damage, "melee");
            projectile.ai[0] = 1;
            return false;
        }
