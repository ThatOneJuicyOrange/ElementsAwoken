...
namespace ElementsAwoken.Projectiles
{
    public class ChaoticBlast : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Chaotic Blast");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.rand.Next(3) == 0)
            {
                ...
                for (int i = 0; i < numberProjectiles; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value15.X, value15.Y, mod.ProjectileType("ChaosShard"), projectile.damage / 2, 2f, projectile.owner, 0f, 0f);
                }
            }
        }
    }
