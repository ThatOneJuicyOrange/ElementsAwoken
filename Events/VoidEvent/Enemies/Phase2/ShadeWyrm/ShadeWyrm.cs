...
namespace ElementsAwoken.Events.VoidEvent.Enemies.Phase2.ShadeWyrm
{
    [AutoloadBossHead]

    class ShadeWyrmHead : ShadeWyrm
    {
        public override string Texture { get { return "ElementsAwoken/Events/VoidEvent/Enemies/Phase2/ShadeWyrm/ShadeWyrmHead"; } }
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Events/VoidEvent/Enemies/Phase2/ShadeWyrm/ShadeWyrmBody"; } }
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Events/VoidEvent/Enemies/Phase2/ShadeWyrm/ShadeWyrmTail"; } }
        ...
        public override void AI()
        {
            ...
            if (head && collision && aiTimer == 600)
            {
                for (int i = 0; i < Main.maxNPCs; i++)
                {
                    ...
                    if (other.type == mod.NPCType("ShadeWyrmHead") || other.type == mod.NPCType("ShadeWyrmBody") || other.type == mod.NPCType("ShadeWyrmTail"))
                    {
