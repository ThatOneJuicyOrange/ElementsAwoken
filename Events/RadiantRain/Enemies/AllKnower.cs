...
namespace ElementsAwoken.Events.RadiantRain.Enemies
{
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Events/RadiantRain/Enemies/AllKnowerHead"; } }
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Events/RadiantRain/Enemies/AllKnowerBody"; } }
    ...
    {
        public override string Texture { get { return "ElementsAwoken/Events/RadiantRain/Enemies/AllKnowerTail"; } }
    ...
    public abstract class AllKnower : Worm
    {
        ...
        {
            DisplayName.SetDefault("All Knower");
        }
    ...
    public abstract class Worm : ModNPC
    {
        ...
        private void FallThroughPlatforms()
        {
            if (head)
            {
                ...
                if (TileID.Sets.Platforms[platformTile.type] && npc.Bottom.Y < P.Bottom.Y && platformTile.active())
                {
                    npc.collideX = false;
                    npc.collideY = false;
