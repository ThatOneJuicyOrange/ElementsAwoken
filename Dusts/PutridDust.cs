	...
	public class PutridDust : ModDust
	{
        ...
        public override bool Update(Dust dust)
        {
            ...
            if (dust.customData is Vector2 position)
            {
                ...
                if (ElementsAwoken.dustTimer[dust.dustIndex] < 30) dust.velocity *= 0.95f;
                else
                {
                ...
                if (ElementsAwoken.dustTimer[dust.dustIndex] > 60 && Vector2.Distance(position, dust.position) < 16) dust.active = false;
